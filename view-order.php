...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>View Purchase Order - IMS</title>
        ...
        <div class="content">
          <div class="content_main">
            <div class="row">
              ...
              <div class="col-12">
                <h1 class="sectionHeader"><span class="icon"> <i class="fa fa-navicon"></i> </span>Purchase orders List</h1>
                <p id="noData" style="color: #9f9f9f">No order requested.</p>
                <div class="section_content">
                  <div class="poListContainers">
                    <?php
                      $stmt = $conn->prepare("
                        SELECT order_product.id, order_product.product, products.product_name, order_product.quantity_ordered, users.first_name, order_product.batch, order_product.quantity_received, users.last_name, suppliers.supplier_name, order_product.status, order_product.created_at
                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="button" class="appbtn appDeliveryHistory" data-id="<?= $batch_po['id'] ?>" value="Deliveries">
                            </td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
                      <div class="poUpdateBtnContainer alignRight">
                        <input type="button" class="appbtn updatePoBtn" data-id= "<?= $batch_id ?>" value="Update">
                      </div>
                    </div>
      ...
      this.registerEvents = function(){
        document.addEventListener('click',function(e) {
          ...
          if (classList.contains('updatePoBtn')) {
            ...
            // containerEl = document.getElementById('1698035946');
            ...
            suppierList = document.querySelectorAll('#' + batchNumberContainer + ' .po_qty_supplier');
            ...
            for (var i = 0; i < productList.length; i++) {
              poListsArr.push({
                ...
                supplier: suppierList[i].innerText,
          ...
          if (classList.contains('appDeliveryHistory')) {
            ...
            $.get('database/view-delivery-history.php', {id: id}, function(data) {
              if (data.length) {
                ...
                BootstrapDialog.alert({
                  title: '<strong>No Delivery Histroy</strong>',
